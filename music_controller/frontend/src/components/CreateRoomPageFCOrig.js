...
const CreateRoomPage = props => {
    ...
    // these also basically act as default props since we pass these as props from RoomFCOrig.js to display the settings page
    // in RoomFCOrig.js by reusing this component, but check for props passed in at return () or use these values.
