...
import CreateRoomPage from "./CreateRoomPageFCOrig";
...
const Room = (props) => {
    ...
    function getRoomDetails() {
        ...
        fetch(`/api/get-room?code=${roomCode}`)
            .then((response) => {
                console.log("In RoomFCOrig.js called getRoomDetails....");
                // we do not want to render RoomFCOrig.js component if there is no room to display! data will not have attributes
